...
if __name__ == "__main__":
    ...
    base_path = Path("/home/javastral/GIT/ANE2-GCPDS/Datasets/ANEaudios")  # folder with .wav
    ...
    if not base_path.exists():
        ...
        audio_files = [p.name for p in base_path.glob("*.wav")][:40]
        ...
        if not audio_files:
            ...
            # This part remains the same, as the `best_params` dict now has compatible types
            final_nn_config = {
                "model_type": base_config["model_type"],
